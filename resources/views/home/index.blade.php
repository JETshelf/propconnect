            ...
            <div class="row clearfix">
                            ...
                            <div class="body">
                                @if ($property->propertyImages->isNotEmpty())
                                    <img class="img-thumbnail img-fluid"
                                        src="{{ asset('storage/' . $property->propertyImages->first()->image_path) }}"
                                        alt="img">
                                @else
                                    <img class="img-thumbnail img-fluid" src="{{ asset('path/to/placeholder/image.jpg') }}"
                                        alt="img">
                                @endif
                                <h6 class="text-success mt-3">KSH {{ $property->price_rent }}</h6>
                                <h5 class="mt-0"><a href="{{ route('home.viewProperty', $property->id) }}"
                                        class="col-blue-grey">{{ $property->property_name }}</a></h5>
                                <p class="text-muted">{{ $property->property_description }}</p>
                                <small class="text-muted"><i
                                        class="zmdi zmdi-pin mr-2"></i>{{ $property->property_location }}</small>
                                <div class="d-flex justify-content-between mt-3 p-3 bg-light">
                                    ...
                                    <a href="#" title="Garages"><i class="zmdi zmdi-home mr-2"></i><span>
                                            24H</span></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="body">
                                <p class="strong">There are no properties currently</p>
                            </div>
                        </div>
                    </div>
